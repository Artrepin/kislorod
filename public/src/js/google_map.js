function initMap() {
    function e(e, t) {
        var s = new google.maps.Marker({
            ...
            a = '<div class="marker"><p class="adress">' + t + "</p></div>",
    ...
    ! function(t) {
        (new google.maps.Geocoder).geocode({
            ...
            if (o === google.maps.GeocoderStatus.OK) {
                var n = s[0].geometry.location;
                a.extend(n), e(n, t), i.fitBounds(a), i.panToBounds(a)
            } else console.log("Адрес не найден по следующим причинам: " + o)
        })
    }(mapAdress.innerHTML), google.maps.event.addDomListener(window, "resize", function() {
        i.fitBounds(a), i.panToBounds(a)
